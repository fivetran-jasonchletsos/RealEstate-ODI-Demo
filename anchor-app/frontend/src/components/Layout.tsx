        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <p className="leading-relaxed text-white/70">
              Yardi Voyager, MRI, VTS, Procore, Honeywell BMS, CoStar, S&amp;P feeds → Fivetran → Iceberg on S3 → dbt labs + dbt-wizard → Great Expectations → Snowflake / Athena / Trino → run-time agents → NewCo Activations → VTS. Humans and run-time agents read the same gold layer.
            </p>
            <div className="mt-3 flex items-center gap-2 text-[11px]">
              <span className="inline-flex items-center gap-1.5 rounded-sm border border-white/15 bg-white/5 px-2 py-1">
                ...
                <span className="font-semibold text-white/80">NewCo</span>
              </span>
              ...
              <span className="inline-flex items-center gap-1.5 rounded-sm border border-white/15 bg-white/5 px-2 py-1">
                ...
                <span className="font-semibold text-white/80">Snowflake</span>
              </span>
            </div>
          </div>
          <div>
