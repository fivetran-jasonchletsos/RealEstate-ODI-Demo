...
//
// Ported to Anchor Properties: CRE / REIT industry. Building IoT replaces
// HL7 streams; SOX / SOC 2 / GAAP replaces HIPAA in the governance band.
      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Building IoT streams via Kinesis</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">SOC 2 · SOX · GAAP · row-level access · column masking</span>
          </div>
    ...
    <svg className="am-flow-svg" viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="none" aria-hidden>
      <defs>
        <linearGradient id="am-flow-grad" x1="0" x2="1" y1="0" y2="0">
          ...
          <stop offset="100%" stopColor="#c8a951" stopOpacity="0.7" />
        </linearGradient>
      </defs>
    ...
    case 'hl7':
      return (
        <svg {...common}>
          ...
          <path d="M5 17 L9 11 L12 14 L15 8 L19 17 Z" fill="#ffffff" />
          <circle cx="18" cy="7" r="2" fill="#ffffff" />
        </svg>
      );
    case 'cms':
      return (
...
.am-medallion-gold   { border-top-color: #c8a951; }
