    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mb-12">
            ...
            <tbody className="divide-y divide-[var(--hairline-soft)]">
              {data?.connectors.map((c) => (
                <tr key={c.id}>
                  ...
                  <td className="px-4 py-3 text-[var(--ink-muted)]">{c.category}</td>
                  ...
                  <td className="px-4 py-3 text-right tabular text-[var(--ink-soft)]">{c.freshness_sla_minutes} min</td>
        ...
        <div className="mt-3 text-[11px] text-[var(--ink-soft)]">
          Lineage label across all rows: <strong>Fivetran</strong> as the managed-ingest layer.
        </div>
      </section>
